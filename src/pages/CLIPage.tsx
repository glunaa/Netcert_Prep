...
const windowsCommands: CommandGroup[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { cmd: 'Test-NetConnection', desc: 'PowerShell: test TCP port connectivity', example: 'Test-NetConnection -ComputerName google.com -Port 443' },
    ],
  },
  {
    category: 'DNS',
